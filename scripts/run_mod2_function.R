...
run_mod2 <- function(dataIN, varname, sitename, scale, Z, h, fc, fclay, fsand, newinits = F, overwrite = F, lowdev = F, post_only = F){
  ...
  initfilename <- paste("./output_model2/inits/", sitename, "/inits_", varname, "_",scale, ".RData", sep = "")
  #initlowfilename <- paste("./output_model1/inits/", sitename, "/initlow_", varname, "_",scale, ".RData", sep = "")
  jm_codafilename <- paste("./output_model2/coda/", sitename, "/jm_coda_", varname, "_",scale,".RData", sep = "")
  mcmcfoldername <- paste("./output_model2/convergence/", sitename, "/", varname, "_", scale, sep = "")
  mcmcfilename <- paste("MCMC_", varname, "_", scale, sep = "")
  dffilename <- paste("./output_model2/df/df_", sitename, "_", varname, "_", scale, ".csv", sep = "")
